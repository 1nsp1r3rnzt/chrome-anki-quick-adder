...
function savedNotesLoad() {
    ...
    MyCustomDirectLoadStrategy.prototype =
        new jsGrid.loadStrategies.PageLoadingStrategy();
    ...
    var showDetailsDialog = function (editNote) {
        ...
        formSubmitHandler = function () {
            ...
            $("#jsGrid").jsGrid("updateItem", editNote);
